#!/bin/bash
# Removes the macOS quarantine flag so ImgSnips.app opens without Gatekeeper
...
APP="$DIR/ImgSnips.app"

if [ ! -d "$APP" ]; then
    echo "Could not find ImgSnips.app next to this script."
...
echo "Done. Try opening ImgSnips.app now -- it should launch without a warning."
read -p "Press Enter to close this window..."
